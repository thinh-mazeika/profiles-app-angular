  ...
  createDb() {
    const profiles = [
      ...
      },
      {
        ...
        socialProfiles: ['facebook', 'linkedin', 'google'],
      },
      {
        id: 3,
        ...
        socialProfiles: ['facebook', 'twitter', 'google'],
      },
      {
        id: 4,
        ...
        socialProfiles: ['facebook', 'twitter', 'instagram', 'linkedin'],
      },
      {
        id: 5,
        ...
        socialProfiles: ['twitter', 'instagram', 'linkedin', 'google'],
      },
      {
        id: 6,
        ...
        socialProfiles: ['twitter', 'instagram', 'google'],
      },
      {
        id: 7,
        ...
        socialProfiles: ['linkedin', 'google'],
      },
      {
        id: 8,
